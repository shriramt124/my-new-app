    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="flex">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div className="relative">
              <select 
                ...
                className="appearance-none bg-white text-gray-700 px-4 py-2 pr-8 rounded-lg text-sm font-medium border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
              >
        ...
        <div className="w-80 bg-white border-l border-gray-200 p-6 space-y-8">
          ...
          <div className="bg-gray-50 rounded-xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-100 hover:border-green-200 transition-colors">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm font-medium text-gray-700">DNS Services</span>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-100 hover:border-green-200 transition-colors">
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                  <span className="text-sm font-medium text-gray-700">LDAP Connection</span>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-100 hover:border-green-200 transition-colors">
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                  <span className="text-sm font-medium text-gray-700">Kerberos Auth</span>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-100 hover:border-green-200 transition-colors">
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                  <span className="text-sm font-medium text-gray-700">Replication</span>
                </div>
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-100 hover:border-blue-200 transition-colors">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-500 mt-1">DC01.company.local</div>
                    <div className="text-xs text-gray-400 mt-1">4 min ago</div>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-lg p-4 border border-gray-100 hover:border-green-200 transition-colors">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-500 mt-1">Sales-Team</div>
                    <div className="text-xs text-gray-400 mt-1">15 min ago</div>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-lg p-4 border border-gray-100 hover:border-yellow-200 transition-colors">
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 flex-shrink-0"></div>
                  <div className="flex-1 min-w-0">
                    <div className="text-sm font-medium text-gray-900">Policy Warning</div>
                    <div className="text-xs text-gray-500 mt-1">Password policy</div>
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-100 hover:border-green-200 transition-colors">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-500 mt-1">System state</div>
          ...
          {/* Status Section */}
          <div className="bg-gray-50 rounded-xl border border-gray-100 p-4 shadow-sm">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                <span className="text-sm font-medium text-gray-900">System Ready</span>
              </div>
              <span className="text-xs text-gray-500 bg-white px-2 py-1 rounded border">Last refresh: 2:15 PM</span>
            </div>
          </div>
        </div>
      </div>
