        ...
        <div className="max-w-7xl mx-auto">
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: 'Active Cases', value: '12', icon: 'fas fa-folder-open', color: 'red' },
                { title: 'Evidence Items', value: '348', icon: 'fas fa-file-archive', color: 'blue' },
                { title: 'Reports Generated', value: '67', icon: 'fas fa-file-alt', color: 'emerald' },
                { title: 'Analysis Hours', value: '1,245', icon: 'fas fa-clock', color: 'purple' }
              ].map((stat, index) => (
